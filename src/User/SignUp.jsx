                    ...
                    <div className="right-block w-[110%] p-8">
                        ...
                        <form onSubmit={handleSignup}>
                            ...
                            <div className="signup-btn mt-[20px]  flex justify-center items-center">
                                <button className='rounded-full w-[28vw] lg:text-xl md:text-lg  text-sm font-bold h-[6vh] bg-gradient-to-r from-[#818cf8] via-[#3b82f6] to-[#4f46e5] text-white hover:scale-90 transition duration-200' type='submit'>Sign Up</button>
                            </div>
                        </form>
